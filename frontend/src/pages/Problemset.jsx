      ...
      <div className="min-h-screen w-full bg-slate-50 dark:bg-[#0B1120] text-slate-800 dark:text-slate-200 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col gap-10 relative z-10">
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-end justify-between border-b border-slate-200/60 dark:border-slate-800/60 pb-6 relative z-20">
              ...
              <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                ...
                <button
                  ...
                  className={`font-mono text-[12px] cursor-pointer font-bold tracking-wide rounded-sm transition-all flex items-center justify-center gap-2 px-5 py-2.5 uppercase shadow-sm ${
                  ...
                  >
                        ...
                        {difficultyOptions.map((d) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-4 py-1.5 rounded-sm font-mono text-[11px] font-bold tracking-wide uppercase border transition-all ${
                                active
                                  ? "bg-orange-500 text-white border-orange-500 shadow-[0_0_10px_rgba(59,130,246,0.3)]"
                        ...
                        {allTags.map((tag) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-2.5 py-1.5 cursor-pointer rounded-sm font-mono text-[10px] uppercase tracking-wide border transition-all ${
                                active
                                  ? "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/30 font-bold"
                    ...
                    <div className="flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-950/50">
                      <button
                        ...
                        className="font-mono cursor-pointer text-[11px] font-bold text-slate-500 dark:text-slate-400 hover:text-rose-500 dark:hover:text-rose-400 uppercase tracking-widest transition-colors"
                      >
                        Reset All
                      </button>
                      <button
                        ...
                        className="font-mono cursor-pointer text-[12px] font-extrabold tracking-wide rounded-sm bg-orange-600 hover:bg-orange-500 text-white px-6 py-2 uppercase transition-colors shadow-md shadow-orange-500/20"
                      >
                        Apply Filters
                      </button>
                    </div>
            ...
            <div className="w-full bg-white/80 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200 dark:border-slate-800/80 rounded-md shadow-lg dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] overflow-hidden">
                        ...
                        >
                          ...
                          <td className="px-6 py-5 text-center">
                            <button
                              ...
                              className="inline-flex cursor-pointer items-center justify-center w-8 h-8 rounded-md font-mono text-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 hover:text-orange-500 hover:border-orange-500 dark:hover:text-orange-400 dark:hover:border-orange-400 transition-all"
                              title="Add to List"
                            >
                              +
                            </button>
