        ...
        >
          ...
          <div className="px-5 pt-6 pb-2 flex-shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className="px-2 py-0.5 rounded-[3px] bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 font-mono text-[10px] font-bold uppercase tracking-wider border border-blue-200 dark:border-blue-800/30">
                Time Limit: 2.0s
              </span>
              <span className="px-2 py-0.5 rounded-[3px] bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 font-mono text-[10px] font-bold uppercase tracking-wider border border-purple-200 dark:border-purple-800/30">
                Memory Limit: 256MB
              </span>
            </div>
          </div>
