...
const EmptyRow = ({ cols, text }) => (
  <tr>
    <td colSpan={cols} className="px-5 py-12 text-center text-slate-400 dark:text-slate-500 font-sans text-[11px] font-semibold tracking-wide bg-white dark:bg-[#0d1117]">
      {text}
    </td>
  </tr>
);
              ...
              <section>
                ...
                <TableShell head={[
                  ...
                  {running.length === 0
                    ...
                    : running.map(c => (
                      <tr key={c.id} className="transition-colors group odd:bg-white even:bg-slate-50 dark:odd:bg-[#0d1117] dark:even:bg-slate-900/40 hover:bg-slate-100 dark:hover:bg-slate-800/80 cursor-pointer">
              ...
              <section>
                ...
                <TableShell head={[
                  ...
                  {upcoming.length === 0
                    ...
                    : upcoming.map(c => (
                      <tr key={c.id} className="transition-colors group odd:bg-white even:bg-slate-50 dark:odd:bg-[#0d1117] dark:even:bg-slate-900/40 hover:bg-slate-100 dark:hover:bg-slate-800/80">
              ...
              <section>
                ...
                <TableShell head={[{label:"Contest"},{label:"Start"},{label:"Duration",center:true},{label:"Participants",center:true}]}>
                  {past.length === 0
                    ...
                    : past.map(c => (
                      <tr key={c.id} className="transition-colors group odd:bg-white even:bg-slate-50 dark:odd:bg-[#0d1117] dark:even:bg-slate-900/40 hover:bg-slate-100 dark:hover:bg-slate-800/80 cursor-pointer" onClick={() => navigate(`/contests/${c.id}`)}>
                        <td className="px-5 py-4 relative">
