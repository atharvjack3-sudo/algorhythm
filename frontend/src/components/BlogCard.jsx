...
export default function BlogCard({ blog }) {
  return (
    <Link to={`/blogs/${blog.slug}`} className="block group">
      {/* Updated card background, border depth, and shadow to match the parent layout */}
      <div className="bg-white dark:bg-[#12141c] border border-slate-300 dark:border-slate-800/70 rounded-md p-6 hover:shadow-lg hover:shadow-slate-300/50 dark:hover:shadow-none hover:border-orange-400 dark:hover:border-orange-500/50 transition-all duration-300">
        ...
        <div className="flex items-start justify-between gap-4 mb-5">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-3 text-[13px] text-slate-500 dark:text-slate-400">
              <div className="flex items-center gap-2">
                {/* Changed bg-blue-50 to bg-orange-50 for brand consistency in light mode */}
                <div className="w-7 h-7 bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 rounded-full flex items-center justify-center font-bold text-[11px]">
          ...
          {/* Replaced blue hover state with orange to match the Algorhythm aesthetic */}
          <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800/50 flex items-center justify-center flex-shrink-0 group-hover:bg-orange-50 dark:group-hover:bg-orange-500/10 transition-colors">
        ...
        {/* Stats Section - Updated top border for light mode depth */}
        <div className="flex items-center gap-6 pt-4 border-t border-slate-200 dark:border-slate-800/70">
